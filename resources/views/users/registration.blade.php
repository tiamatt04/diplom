    ...
    <div class="section container">
        <div class="row w-50 " style="background: white;margin-top: 150px;margin-left: 320px;border-radius: 8px;box-shadow: 0 14px 28px rgba(0, 0, 0, 0.25), 0 10px 10px rgba(0, 0, 0, 0.22);">
            <form method="post" class="p-4">
                <div class="d-flex">
                    <span class="input-group-text w-100 mb-3 fs-4 disabled">Регистрация</span>
                    <a class="input-group-text w-100 mb-3 fs-4 bg-danger border-danger btn" style="margin-left: -15px;" href="{{route('auth')}}">Авторизация</a>
                </div>
